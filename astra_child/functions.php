...
function theme_enqueue_styles(){
    ...
    wp_enqueue_script( 'script', get_stylesheet_directory_uri() . '/particles.js', array('jquery'), '1.0', true);
    wp_enqueue_script( 'script', get_stylesheet_directory_uri() . '/app.js', array('jquery'), '1.0', true);
}
?>